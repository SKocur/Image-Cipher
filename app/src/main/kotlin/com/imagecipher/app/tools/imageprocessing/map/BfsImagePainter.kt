...
object BfsImagePainter {

    private val logger = LogManager.getLogger()

    /**
     * Breadth First Search algorithm to color pixels in an image.
     *
     ...
     * @param point Starting point for the BFS algorithm
    ...
    fun paintImage(
        ...
        logger.debug("BFS painting image, $point")
        ...
        // Additional BFS logic to be implemented here
