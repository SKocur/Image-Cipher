...
public class CommandArgs {
  ...
  @Parameter(names = {"-EM",
      "--enryption-mode"}, description = "Encryption mode: 1 - SingleColorEncryption, 2 - MultiColorEncryption, 3 - LowLevelBitEncryption, 4 - RSAEncryption")
  public int encryptionMode = 0; // If 0, then message will not be encrypted

  @Parameter(names = {"-DM",
      "--decryption-mode"}, description = "Decryption mode: options as in encryption mode")
  public int decryptionMode = 0; // If 0, then message will not be decrypted

  @Parameter(names = {"-f",
      "--file-name"}, description = "Path to file which will store encrypted data")
  public String originalFileName;

  @Parameter(names = {"-cf",
      "--certificate-file"}, description = "Path to file that contains certificate")
